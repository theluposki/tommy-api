...
// src/domain/entities/User/User.spec.js
describe("testing the user entity", () => {
  test("User should be an object", () => {
    globalExpect(typeof User).toBe("object");
  });
  test("User is expected to have the createUser property", () => {
    globalExpect(User.hasOwnProperty("createUser")).toBeTruthy();
  });
  test("the createUser property is expected to be a function", () => {
    globalExpect(typeof User.createUser).toBe("function");
  });
});
